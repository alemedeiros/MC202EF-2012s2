 ...
 * sobre uma árvore rubro-negra.
 *
 *  Comandos aceitos:
 *       i <ra> <nome> insere novo nó com ra e nome
 *       c <ra>        consulta ra
 *       n  imprime o número de nós na árvore
 *       m  imprime o número de nós negros na árvore
 *       a  imprime a altura da árvore
 *       b  imprime a altura negra da árvore
 *       d  imprime uma representação gráfica da árvore
...
int main() {
  ...
  do { 
	...
	break;
      ...
      case 'M':
	ImprimeComentario();
	printf("Número de nós negros na base de dados: %d.\n", NumeroNosNegrosBase(&base));
	break;
	...
	break;
      ...
      case 'B':
	ImprimeComentario();
	printf("Altura negra da base de dados: %d.\n", AlturaNegraBase(&base));
	break;
	...
	ImprimeComentario();
	LiberaBase(&base);
	base = CriaBase(); /* Reinicializa base */
	break;
	...
	printf("m             : imprime o número de nós negros na base.\n");
	printf("a             : imprime a altura da base.\n");
	printf("b             : imprime a altura negra da base.\n");
        printf("d             : imprime uma representação gráfica da árvore.\n");
